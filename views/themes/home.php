                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">
                                               Média Lucro (Mensal) - <?=$currentDate[2]?></div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-8 col-lg-7">
                            <div class="card shadow mb-4">
                                ...
                                <div
                                    ...
                                    <h6 class="m-0 font-weight-bold text-primary">Visão Geral - <?= $currentDate[2] ?></h6>
                        ...
                        <div class="col-xl-4 col-lg-5">
                            <div class="card shadow mb-4">
                                ...
                                <div
                                    class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                                    <h6 class="m-0 font-weight-bold text-primary">Porcentagens Financeiras - <?= convertMonth($currentDate[1])." de ".$currentDate[2] ?></h6>
                                    <div class="dropdown no-arrow">
                                        <a class="dropdown-toggle" href="#" role="button" id="dropdownMenuLink"
                                            data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                            <i class="fas fa-ellipsis-v fa-sm fa-fw text-gray-400"></i>
...
<?php  if (!empty($dataDashboard) && !empty($minDate) ){
   echo scriptJs("dataFinance = ". json_encode($dataDashboard) . "; minDate = " . json_encode($minDate)); 
}; 
?>
<script>
    ...
    {   
        ...
        average = average/(profit.length - minDate + 1)
